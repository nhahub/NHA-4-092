...
export default function App() {
  return (
    ...
    <Routes>
      ...
      {/* Onboarding */}
      <Route path="/onboarding/goal" element={<ProtectedRoute><GoalSelection /></ProtectedRoute>} />
      <Route path="/onboarding/goal-results" element={<ProtectedRoute><GoalSearchResults /></ProtectedRoute>} />
      <Route path="/onboarding/skill-level" element={<ProtectedRoute><SkillLevelSelection /></ProtectedRoute>} />
      <Route path="/onboarding/schedule" element={<ProtectedRoute><WeeklySchedule /></ProtectedRoute>} />
      <Route path="/onboarding/generating" element={<ProtectedRoute><AIGeneration /></ProtectedRoute>} />
      <Route path="/onboarding/generation-failed" element={<ProtectedRoute><AIGenerationFailed /></ProtectedRoute>} />

      {/* Roadmap */}
      <Route path="/roadmap" element={<ProtectedRoute><RoadmapTimeline /></ProtectedRoute>} />
      <Route path="/roadmap/empty" element={<ProtectedRoute><NoRoadmapEmptyState /></ProtectedRoute>} />
      <Route path="/roadmap/phase/:phaseId" element={<ProtectedRoute><RoadmapPhaseDetails /></ProtectedRoute>} />
      <Route path="/roadmap/phase/:phaseId/lesson/:lessonIndex" element={<ProtectedRoute><LessonDetails /></ProtectedRoute>} />
      <Route path="/roadmap/completed" element={<ProtectedRoute><CompletedRoadmap /></ProtectedRoute>} />
